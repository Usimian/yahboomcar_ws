...
Usage:
ros2 launch slam_nav slam_nav_cam_client_hub.launch.py client_hub_url:=http://192.168.1.100:5000
"""
...
def generate_launch_description():
    ...
    # Delayed robot server launch - start after robot systems are ready
