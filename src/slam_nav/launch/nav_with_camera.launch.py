...
def generate_launch_description():
    ...
    # === ROBOT BRINGUP ===
    # Robot bringup (base_node, robot_state_publisher, static transforms)
    ...
    # === SLAM TOOLBOX ===
    # SLAM Toolbox - start after robot bringup
    ...
    # 1. Robot platform + Camera first (immediate)
    # 2. Nav2 stack second (with delay)  
    # 3. SLAM Toolbox third (with longer delay)
    
    # Group Nav2 launch with delayed start
    ...
    return LaunchDescription([
        ...
        delayed_slam_group,
        # 4. Initial pose publisher (12s delay)
